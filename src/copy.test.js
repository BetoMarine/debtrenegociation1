...
describe("product copy", () => {
  ...
  it("Fortune Teller never claims a set-for-life score or Envizage", () => {
    ...
    expect(FORTUNE_STRINGS.en.stackFoot).toMatch(/timeline above/i);
    expect(FORTUNE_STRINGS.en.timelineTitle).toMatch(/your plan/i);
    expect(FORTUNE_STRINGS.en.timelineHint).toMatch(/start, finish/i);
    expect(FORTUNE_STRINGS.en.stackDetail).toMatch(/stage detail/i);
    ...
    expect(FORTUNE_STRINGS.en.version).toMatch(/0\.9\.8/);
    ...
    expect(FORTUNE_STRINGS.en.stackFoot).toMatch(/overlap/i);
