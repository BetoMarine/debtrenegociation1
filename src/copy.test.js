...
describe("product copy", () => {
  ...
  it("Fortune Teller never claims a set-for-life score or Envizage", () => {
    ...
    expect(FORTUNE_STRINGS.en.version).toMatch(/0\.9\.12/);
    ...
    expect(FORTUNE_STRINGS.en.stackFoot).not.toMatch(/overlap/i);
    expect(FORTUNE_STRINGS.en.stackFoot).not.toMatch(/path pins/i);
    expect(FORTUNE_STRINGS.en.stageRollup).not.toMatch(/rollup/i);
    expect(FORTUNE_STRINGS.en.journeyShelf).not.toMatch(/shelf/i);
